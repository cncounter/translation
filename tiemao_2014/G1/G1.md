...
- If you have not done so, download and install the latest version of the Java JDK (JDK 7 u9 or later).[Java 7 JDK Downloads](http://www.oracle.com/technetwork/java/javase/downloads/index.html)
