...
[`INFORMATION_SCHEMA.INNODB_TEMP_TABLE_INFO`](https://dev.mysql.com/doc/refman/5.7/en/information-schema-innodb-temp-table-info-table.html) 提供了当前 `InnoDB` 实例中处于活动状态的, 用户创建的临时表的元数据信息。 更多信息，请参阅 [Section 14.16.7, `InnoDB INFORMATION_SCHEMA Temporary Table Info Table`](https://dev.mysql.com/doc/refman/5.7/en/innodb-information-schema-temp-table-info.html).
