...
| 90    | (0x5a)  | dup_x1   | 复制1个栈顶的32bit值，x1表示将复制的值跨1个值, 插入原始值下面的1个32bit值的下方 |
| 91    | (0x5b)  | dup_x2   | 复制1个栈顶的32bit值，x2表示将复制的值跨2个值, 插入原始值下面的2个32bit值的下方 |
| 92    | (0x5c)  | dup2     | 复制栈顶的2个32bit操作数/或者1个64bit操作数,并压入栈顶        |
| 93    | (0x5d)  | dup2_x1  | 复制2个栈顶的32bit值/或1个64bit值，x1表示将复制的值跨1个值, 按原始顺序，插入原始值下面的1个32bit值的下方 |
| 94    | (0x5e)  | dup2_x2  | 复制2个栈顶的32bit值/或1个64bit值，x2表示将复制的值跨2个值, 按原始顺序，插入原始值下面的2个32bit值的下方       |
