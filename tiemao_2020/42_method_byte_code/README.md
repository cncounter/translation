...
| 十进制 | 十六进制 | 助记符      | 附带字节操作数 | 出栈  | 入栈 |  效果说明        |
| :---  | :---    | :---       | :---     | :---     | :---      | :---           |
...
| 十进制 | 十六进制 | 助记符      | 附带字节操作数 | 出栈  | 入栈 |  效果说明        |
| :---  | :---    | :---       | :---     | :---     | :---      | :---           |
| 178   | (0xb2)  | getstatic      | 0        |      0   |    0      |  |
| 179   | (0xb3)  | putstatic      | 0        |      0   |    0      |  |
| 180   | (0xb4)  | getfield       | 0        |      0   |    0      |  |
| 181   | (0xb5)  | putfield       | 0        |      0   |    0      |  |
| 182   | (0xb6)  | invokevirtual  | 0        |      0   |    0      |  |
| 183   | (0xb7)  | invokespecial  | 0        |      0   |    0      |  |
| 184   | (0xb8)  | invokestatic   | 0        |      0   |    0      |  |
| 185   | (0xb9)  | invokeinterface| 0        |      0   |    0      |  |
| 186   | (0xba)  | invokedynamic  | 0        |      0   |    0      |  |
| 187   | (0xbb)  | new            | 0        |      0   |    0      |  |
| 188   | (0xbc)  | newarray       | 0        |      0   |    0      |  |
| 189   | (0xbd)  | anewarray      | 0        |      0   |    0      |  |
| 190   | (0xbe)  | arraylength    | 0        |      0   |    0      |  |
| 191   | (0xbf)  | athrow         | 0        |      0   |    0      |  |
| 192   | (0xc0)  | checkcast      | 0        |      0   |    0      |  |
| 193   | (0xc1)  | instanceof     | 0        |      0   |    0      |  |
| 194   | (0xc2)  | monitorenter   | 0        |      0   |    0      |  |
| 195   | (0xc3)  | monitorexit    | 0        |      0   |    0      |  |
...
依赖于特定JVM平台的实现, 一般在class文件中不会出现, 如果JIT或者调试器不认识则直接忽略, 不需要报错。
