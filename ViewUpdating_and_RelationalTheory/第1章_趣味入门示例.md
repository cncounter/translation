...
表 S 对应的是合同供应商. 每个供应商都有唯一编号(SNO, supplier number), 
...
2' Throughout this book I use the term key, unqualified, to mean a candidate key, not necessarily a primary key specifically. In
...
3' I remind you from the preface that throughout this book I use “SQL and Relational Theory” as an abbreviated form of reference
