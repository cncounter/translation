...
*(及时(JIT)编译)(# jit_compilation)
*(法区)(# method_area)
*(类文件结构)(# class_file_structure)
*(Classloader)(#类加载器)
*(更快的类加载)(# faster_class_loading)
*(的方法区)(# where_is_the_method_area)
*(类加载器参考)(# classloader_reference)
(运行时常量池)*(# constant_pool)
*(异常表)(# exception_table)
*(符号表)(# symbol_table)
(实习字符串(字符串表))*(# string_table)
